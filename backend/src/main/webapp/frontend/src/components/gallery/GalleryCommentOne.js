...
const GalleryCommentOne = props => {
    ...
    const submitUpdateHandler = async event => {
        ...
        try{
            const response = galleryCommentCtx.updateGalleryComment(updateGalleryComment, authCtx.token);
            navigate(`/club/1/gallery/${galleryId}`)
            ...
            {galleryCommentCtx.galleryComment && (
                <form onSubmit={submitUpdateHandler}>
                    ...
                    <input
                        ...
                        onChange={e => setUpdateGalleryComment({
