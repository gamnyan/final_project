        ...
        <Layout>
          <Routes>
            ...
            <Route
              path="/signup/"
              element={
                authCtx.isLoggedIn ? <Navigate to="/1/1" /> : <CreateAccountForm />
              }
            />
            <Route
              path="/login/*"
              element={authCtx.isLoggedIn ? <Navigate to="/1/1" /> : <AuthPage />}
            />
            <Route
              path="/profile/"
              element={
            ...
            <Route path="/club" element={<ClubLayout />}>
              ...
              <Route
                path="createclub"
                element={
                  authCtx.isLoggedIn ? <CreateClubPage /> : <Navigate to="/1/1" />
                }
              />
              <Route
                path="updateclub/:clubId"
                element={
                  authCtx.isLoggedIn ? <UpdateClubPage /> : <Navigate to="/1/1" />
                }
              />
